...
<html>
<head>
    <title>99cbf77e Ivan Toroitich Bowen | Profile</title>
    <?php require_once "head.php" ?>
</head>
<body>
    <h1>Profile information</h1>
    <p>First Name: <?php echo($firstName . "\n");?></p>
    <p>Last Name: <?php echo($lastName . "\n");?></p>
    <p>Email: <?php echo($email . "\n");?></p>
    <p>Headline: <br/> <?php  echo("<br>" . $headline . "\n");?></p>
    <p>Summary:<br/> <?php  echo("<br>" . $summary . "\n");?></p>
    <p>
        <?php
